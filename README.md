# Koyal Beta QA Agent — Phase 1

Automated QA for **beta.koyal.ai** auth flow and post-login app shell, using [agent-browser](https://github.com/vercel-labs/agent-browser).
...
Each run creates `reports/<timestamp>/`:
